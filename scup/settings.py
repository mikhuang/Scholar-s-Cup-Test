...
DATABASES = {
    'default': {
        ...
        'NAME': '/usr/local/share/wsgi/project/db/db.sqlite',                      # Or path to database file if using sqlite3.
...
STATIC_ROOT = '/usr/local/share/wsgi/project/static'
...
SECRET_KEY = 'o=hurq6cxjvk%=x(58fpror8w(_cz-7ger75h%f&pw)8^(hwd^'
